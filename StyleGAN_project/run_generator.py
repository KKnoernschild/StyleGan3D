...
def generate_images(network_pkl, seeds, truncation_psi):
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        # Removed the PIL Image From Array and replaced with writing directly to a nrrd file based off the image seed
        filenamewanted = dnnlib.make_run_dir_path('seed%04d.nrrd' % seed)
        nrrd.write(filenamewanted, images[0])
